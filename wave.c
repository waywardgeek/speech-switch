...
static void writeBytes(swWaveFile file, void *bytes, int length) {
  size_t bytesWritten;
...
/* Write a string to a file. */
static void writeString(swWaveFile file, char *string) {
  writeBytes(file, string, strlen(string));
}

/* Write an integer to a file in little endian order. */
static void writeInt(swWaveFile file, int value) {
  char bytes[4];
  int i;
...
static void writeShort(swWaveFile file, short value) {
  char bytes[2];
  int i;
...
static int readBytes(swWaveFile file, void *bytes, int length) {
  if (file->failed) {
    return 0;
  }
...
static void readExactBytes(swWaveFile file, void *bytes, int length) {
  int numRead;
...
static int readInt(swWaveFile file) {
...
static int readShort(swWaveFile file) {
...
static void expectString(swWaveFile file, char *expectedString) {
...
static void writeHeader(swWaveFile file, int sampleRate) {
...
static int readHeader(swWaveFile file) {
  int data;
...
static void closeFile(swWaveFile file) {
